...
output "resources_autoscaling_groups" {
  ...
  value       = element(concat(aws_eks_node_group.this[*].resources[0].autoscaling_groups, list("")), 0)
}
...
output "resources_autoscaling_groups_remote_access_security_group_id" {
  ...
  value       = element(concat(aws_eks_node_group.this[*].resources[0].remote_access_security_group_id, list("")), 0)
}
output "status" {
